...
power.plot <- Power %>%
  ...
  geom_line(aes(y = n1, color = "n1"), linetype = "dashed") + 
  geom_point(aes(y = n1, color = "n1")) +
  geom_line(aes(y = n2, color = "n2"), linetype = "dashed") + 
  geom_point(aes(y = n2, color = "n2")) +
  geom_line(aes(y = n3, color = "n3"), linetype = "dashed") + 
  geom_point(aes(y = n3, color = "n3")) +
  geom_line(aes(y = n4, color = "n4"), linetype = "dashed") + 
  geom_point(aes(y = n4, color = "n4")) +
  geom_line(aes(y = n5, color = "n5"), linetype = "dashed") +
